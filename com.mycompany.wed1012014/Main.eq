...
public class Main: SEScene
{
	...
	public void initialize(SEResourceCache rsc){
		...
		rsc.prepare_image("platform_linuxx86", "platform_linuxx86", get_scene_width()*0.15, get_scene_height()*0.15);
		fg = add_sprite_for_image(SEImage.for_resource("platform_linuxx86"));
		fg.move(100,100);
